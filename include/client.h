...
/** @brief client_chat - function to handle user input, show chat history, send & receieve messages, etc.
  * @param const struct EncryptionDetails* - pointer to struct containing details used to encrypt and decrypt messages
  * @param const int - socket handle of person to message **/
void client_chat(const struct EncryptionDetails*, const int) ;
