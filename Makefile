target:
	...
	clang -Wall -std=c11 -g -lm -I include/ -I libraries/ lib/client.o lib/key_sharing.o lib/aes.o lib/client_manager.o -o bin/razan # client application, copy for everyone to use
